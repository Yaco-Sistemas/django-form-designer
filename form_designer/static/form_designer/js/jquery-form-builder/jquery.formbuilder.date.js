/*
* JQuery Form Builder - Date plugin.
*
* Revision: 1
* Version: 0.1
...
var FbDate = $.extend({}, $.fb.fbWidget.prototype, {
	...
	_getWidget : function(event, fb) {
		...
		fb.target._log('fbDate._getWidget executing...');
		...
		fb.target._log('fbDate._getWidget executed.');
		return $jqueryObject;
	},
    ...
    fb.item.css('fontFamily', fontFamily);
		...
		fb.target._log('fbDate.languageChange executed.');
	}
});

$.widget('fb.fbDate', FbDate);
